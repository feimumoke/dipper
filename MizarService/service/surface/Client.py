...
from service.baserpc.AlkaidService import AlkaidService
import os
import asyncio
from quamash import QEventLoop
from view.MainWindow import MainWindow
import BaseService_pb2
from service.service.ImageService import ImageService
...
class Mychat(QMainWindow, Ui_ChatForm):
    ...
    def showinit(self, friend_info):
        ...
        print("1")
        self.my_avatar_label.setStyleSheet(
            "background-color: gainsboro;border-image: url('%s');" % self.my_info["avatar"])
        self.f_avatar_label.setStyleSheet(
            "background-color: gainsboro;border-image: url('%s');" % friend_info["avatar"])
        print("2")
